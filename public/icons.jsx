/* ============================================================
   Icons — Lucide outline set (2px stroke) + AI model brand marks.
   Exposed on window so every babel file can use <Icon /> / <ModelIcon />.
   ============================================================ */
...
function Icon({ name, size = 20, stroke = 2, color = "currentColor", style = {} }) {
  return (
    <svg
      ...
      viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={stroke}
...
function OpenAIMark({ size = 16 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 260" xmlns="http://www.w3.org/2000/svg" fill="currentColor" aria-hidden="true">
...
function GeminiMark({ size = 16 }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path d="M12 24A14.304 14.304 0 000 12 14.304 14.304 0 0012 0a14.305 14.305 0 0012 12 14.305 14.305 0 00-12 12" fill={`url(#${id})`} fillRule="nonzero"/>
    </svg>
  );
}
...
function ClaudeMark({ size = 16 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" fillRule="evenodd" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path d="M13.827 3.52h3.603L24 20h-3.603l-6.57-16.48zm-7.258 0h3.767L16.906 20h-3.674l-1.343-3.461H5.017l-1.344 3.46H0L6.57 3.522zm4.132 9.959L8.453 7.687 6.205 13.48H10.7z"/>
    </svg>
  );
}

function ModelIcon({ brand, size = 16 }) {
  if (brand === "openai") return <OpenAIMark size={size} />;
  if (brand === "gemini") return <GeminiMark size={size} />;
  if (brand === "claude") return <ClaudeMark size={size} />;
  return <Icon name="sparkles" size={size} />;
}

Object.assign(window, { Icon, ICON_PATHS, OpenAIMark, GeminiMark, ClaudeMark, ModelIcon });
